  ...
  pspdef_t*	psp ) 
{
    ...
    damage = 10000;//(P_Random ()%10+1)<<1;`                        //MOD TO MAKE PUNCHES ONE HIT
    ...
    slope = P_AimLineAttack (player->mo, angle, 5*MELEERANGE);      //MOD TO CHANGE MELEE RANGE
    P_LineAttack (player->mo, angle, 5*MELEERANGE, slope, damage);
